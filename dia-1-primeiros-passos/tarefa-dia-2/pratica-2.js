...
console.log("vai ser if")
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 
if (a > 10) {
    console.log("Verdade! O valor ", a, " é maior que 10");
} else {
    console.log("Falso! O valor ", a, " não é maior 10");
}// e Else por que o valor e igual a 10
console.log("e Else por que o valor e igual a 10")
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 
if (10 <= a) {
...
//if valor e igual a 10
console.log("if o valor e igual a 10")
let b = true
...
}//if o valor B e verdade 
console.log("if o valor B e verdade")
...
}//if o B e considerado verdade
console.log("if o B e considerado verdade")
let c = []
...
}//if c e considerado verdade
console.log("if C e considerado verdade")
let d = [1,2,3,4]
...
}//if o D e considerado como verdade
console.log("if o D e considerado como verdade")
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 
if (d[0] == 1) {
...
}//if a variavel de D e igual a 1
console.log("if a variavel de D e igual a 1")
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): 
if (d[1] == 1) {
...
}//Else D pode ser igual a 1,2,3e4
console.log("Else D pode ser igual a 1,2,3e4")
let e = "Nome"
...
}//if a variavel e uma string 
console.log("if a variavel e uma string")
